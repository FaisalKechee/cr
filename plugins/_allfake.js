...
let sap = ['Hai', 'Kyaa', 'Halo', 'Nyann']
let sapa = ['Hai', 'Kyaa', 'Halo', 'Nyann'].getRandom()
let pp
try {
...
[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'faisaldzop@gmail.com', true],
]
let res = JSON.parse(readFileSync('./package.json'))
global.v = `© BotWhatsapp V${res.version} (By FaisalDev)`
global.api = "Zyko"
...
sourceUrl: "https://instagram.com/faisaldeveloper",
}
}
}
global.fakeig = {
